...
bool W25qxx_Init(void)
{
	...
	printf("w25qxx Page Count: %lu\r\n", w25qxx.PageCount);
	printf("w25qxx Sector Size: %lu Bytes\r\n", w25qxx.SectorSize);
	printf("w25qxx Sector Count: %lu\r\n", w25qxx.SectorCount);
	printf("w25qxx Block Size: %lu Bytes\r\n", w25qxx.BlockSize);
	printf("w25qxx Block Count: %lu\r\n", w25qxx.BlockCount);
	printf("w25qxx Capacity: %lu KiloBytes\r\n", w25qxx.CapacityInKiloByte);
...
void W25qxx_EraseSector(uint32_t SectorAddr)
{
	...
	#if (_W25QXX_DEBUG == 1)
	uint32_t StartTime = HAL_GetTick();
	printf("w25qxx EraseSector %lu Begin...\r\n", SectorAddr);
	#endif
	W25qxx_WaitForWriteEnd();
	...
	W25qxx_WaitForWriteEnd();
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx EraseSector done after %lu ms\r\n", HAL_GetTick() - StartTime);
	#endif
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
}
...
void W25qxx_EraseBlock(uint32_t BlockAddr)
{
	...
	w25qxx.Lock = 1;
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx EraseBlock %lu Begin...\r\n", BlockAddr);
	W25qxx_Delay(100);
	uint32_t StartTime = HAL_GetTick();
	#endif
	W25qxx_WaitForWriteEnd();
...
bool W25qxx_IsEmptyPage(uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToCheck_up_to_PageSize)
{
	...
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckPage is Empty in %lu ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return true;	
	NOT_EMPTY:
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckPage is Not Empty in %lu ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return false;
...
bool W25qxx_IsEmptySector(uint32_t Sector_Address, uint32_t OffsetInByte, uint32_t NumByteToCheck_up_to_SectorSize)
{
	...
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckSector is Empty in %lu ms\r\n", HAL_GetTick()-StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return true;	
	NOT_EMPTY:
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckSector is Not Empty in %lu ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return false;
...
bool W25qxx_IsEmptyBlock(uint32_t Block_Address, uint32_t OffsetInByte, uint32_t NumByteToCheck_up_to_BlockSize)
{
	...
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckBlock is Empty in %lu ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return true;	
	NOT_EMPTY:
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx CheckBlock is Not Empty in %lu ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
	#endif	
	w25qxx.Lock = 0;
	return false;
...
void W25qxx_WriteByte(uint8_t pBuffer, uint32_t WriteAddr_inBytes)
{
	...
	#if (_W25QXX_DEBUG == 1)
	uint32_t StartTime = HAL_GetTick();
	printf("w25qxx WriteByte 0x%02X at address %lu begin...", pBuffer, WriteAddr_inBytes);
	#endif
	W25qxx_WaitForWriteEnd();
	W25qxx_WriteEnable();
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_RESET);
	...
	W25qxx_WaitForWriteEnd();
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx WriteByte done after %lu ms\r\n", HAL_GetTick() - StartTime);
	#endif
	w25qxx.Lock = 0;
}
//###################################################################################################################
void W25qxx_WritePage(uint8_t *pBuffer, uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_PageSize)
{
	...
	if((OffsetInByte + NumByteToWrite_up_to_PageSize) > w25qxx.PageSize)
		NumByteToWrite_up_to_PageSize = w25qxx.PageSize - OffsetInByte;
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx WritePage:%lu, Offset:%lu ,Writes %lu Bytes, begin...\r\n", Page_Address, OffsetInByte, NumByteToWrite_up_to_PageSize);
	W25qxx_Delay(100);
	uint32_t StartTime = HAL_GetTick();
	#endif	
	W25qxx_WaitForWriteEnd();
	...
	printf("\r\n");
	printf("w25qxx WritePage done after %lu ms\r\n", StartTime);
	W25qxx_Delay(100);
	#endif	
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
...
void W25qxx_WriteSector(uint8_t *pBuffer, uint32_t Sector_Address, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_SectorSize)
{
	...
	#if (_W25QXX_DEBUG == 1)
	printf("+++w25qxx WriteSector:%lu, Offset:%lu ,Write %lu Bytes, begin...\r\n", Sector_Address, OffsetInByte, NumByteToWrite_up_to_SectorSize);
	W25qxx_Delay(100);
	#endif	
...
void W25qxx_WriteBlock(uint8_t* pBuffer, uint32_t Block_Address, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_BlockSize)
{
	...
	#if (_W25QXX_DEBUG == 1)
	printf("+++w25qxx WriteBlock:%lu, Offset:%lu ,Write %lu Bytes, begin...\r\n", Block_Address, OffsetInByte, NumByteToWrite_up_to_BlockSize);
	W25qxx_Delay(100);
	#endif	
...
void W25qxx_ReadByte(uint8_t *pBuffer, uint32_t Bytes_Address)
{
	...
	*pBuffer = W25qxx_Spi(W25QXX_DUMMY_BYTE);
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_SET);
	#if (_W25QXX_DEBUG == 1)
	printf("w25qxx ReadByte 0x%02X done after %lu ms\r\n", *pBuffer, HAL_GetTick() - StartTime);
	#endif
	w25qxx.Lock = 0;
}
//###################################################################################################################
void W25qxx_ReadBytes(uint8_t* pBuffer, uint32_t ReadAddr, uint32_t NumByteToRead)
{
	...
	printf("\r\n");
	printf("w25qxx ReadBytes done after %lu ms\r\n", StartTime);
	W25qxx_Delay(100);
	#endif	
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
...
void W25qxx_ReadPage(uint8_t *pBuffer, uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_PageSize)
{
	...
	printf("\r\n");
	printf("w25qxx ReadPage done after %lu ms\r\n", StartTime);
	W25qxx_Delay(100);
	#endif	
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
